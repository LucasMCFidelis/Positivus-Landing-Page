    ...
    <div className="flex flex-col w-full px-5 space-y-12 md:px-12 lg:px-24">
      ...
      <div className="w-full">
        <Card.Header
          ...
          paragraphSize="lg"
        />
        <Card.Wrapper bgColor="tertiary" border="none" size="full" rounded="lg" className="flex gap-x-7 items-center justify-center text-zinc-200 px-14 py-16">
          ...
          <div className="border-x-2 px-4 space-y-4">
            <p className={paragraph({ size: "sm" })}>
