  ...
  return (
    <div className="flex flex-col w-full px-5 md:px-12 lg:px-24">
      ...
      <div className="w-full flex flex-wrap flex-col sm:flex-row items-center justify-center gap-6">
        <div className=" h-80
        justify-items-start items-baseline bg-gray-300 rounded-xl p-14
        grid-areas-mobile-service w-full
        sm:grid-areas-desktop-service sm:w-[550px] sm:items-center "
      >
        ...
        <div className="h-80 w-full sm:h-80 sm:w-[550px] bg-gray-300 rounded-xl"></div>
        <div className="h-80 w-full sm:h-80 sm:w-[550px] bg-gray-300 rounded-xl"></div>
        <div className="h-80 w-full sm:h-80 sm:w-[550px] bg-gray-300 rounded-xl"></div>
      </div>
