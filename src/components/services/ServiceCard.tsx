...
export function ServiceCard({title}: ServiceCardProps) {
    ...
    return (
        ...
        border border-base shadow-base"
        >
            <div className="[grid-area:title]text-title-3-mobile md:text-title-3-desktop  ">
                <h2 className=" bg-lime-400 inline-block rounded-lg py-0.5 px-2">
                    {first}
                </h2>
                <h2 className=" bg-lime-400 inline-block rounded-lg py-0.5 px-2">
                    {last}
