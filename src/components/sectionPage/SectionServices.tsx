    ...
    return (
        <>
            <Card.Header
                ...
                paragraphSize="lg"
            />
            <div className="w-full h-full grid grid-cols-1 grid-rows-6 lg:grid-cols-2 lg:grid-rows-3 gap-8">
                <Card.Service
            ...
            <div className="w-full">
                <Card.Wrapper bgColor="primary" border="none" size="md" rounded="lg" className="relative h-80 lg:mt-24 lg:mb-24">
                    <div className="h-full w-72 flex flex-col gap-6 justify-center items-center lg:items-start">
                    ...
                    <svg className="absolute right-32 -top-10 hidden lg:block" width="359" height="395" viewBox="0 0 359 395" fill="none" xmlns="http://www.w3.org/2000/svg">
